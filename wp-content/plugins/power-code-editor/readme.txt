...
Contributors: Mayel de Borniol
Author URI: http://deborniol.com/
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=10234087
Version: 1.2.1
Stable tag: 1.2.1
Tested up to: 2.9.2
Requires at least: 2.6
Tags: wordpress, blog, coding, source code, source, code, edit, editor, php, html, js, javascript, css, syntax, highlighting, highlight, programmer, programming, developer, development, emacs, vim, admin, theme, themes, plugin, plugins, template, templates
